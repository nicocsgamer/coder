...
import AgentSettingsAPIKeysPage from "./AgentSettingsAPIKeysPage";
...
const meta = {
	...
	component: AgentSettingsAPIKeysPage,
	parameters: {
		user: MockUserOwner,
	},
	decorators: [withToaster, withAuthProvider, withDashboardProvider],
} satisfies Meta<typeof AgentSettingsAPIKeysPage>;

export default meta;
type Story = StoryObj<typeof AgentSettingsAPIKeysPage>;

const apiKeysRouteParameters = reactRouterParameters({
	location: { path: "/agents/settings/api-keys" },
	routing: [{ path: "/agents/settings/api-keys", useStoryElement: true }],
});

export const Default: Story = {
	parameters: {
		reactRouter: apiKeysRouteParameters,
		queries: [
			{

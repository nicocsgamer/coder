-- Records how each interception was authenticated and a masked credential
...
ALTER TABLE aibridge_interceptions ADD COLUMN credential_kind TEXT NOT NULL DEFAULT 'centralized';
ALTER TABLE aibridge_interceptions ADD COLUMN credential_hint TEXT NOT NULL DEFAULT '';
